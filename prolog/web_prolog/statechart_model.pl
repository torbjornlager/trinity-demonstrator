...
statechart_spawn_source(Options, SourceGoal, SpawnOptions) :-
    exclude(is_statechart_control_option, Options, EffectiveOptions),
    partition(is_statechart_source_option, EffectiveOptions, SourceOptions, SpawnOptions),
...
is_statechart_control_option(trace(_)).
