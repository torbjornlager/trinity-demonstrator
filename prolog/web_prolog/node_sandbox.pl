...
:- use_module(isolation, [prepare_actor_module/3]).
...
sandbox:safe_primitive(actors:self(_)).
sandbox:safe_primitive(actors:monitor(_, _)).
sandbox:safe_primitive(actors:demonitor(_)).
sandbox:safe_primitive(actors:demonitor(_, _)).
sandbox:safe_primitive(actors:register(_, _)).
sandbox:safe_primitive(actors:unregister(_)).
sandbox:safe_primitive(actors:whereis(_, _)).
sandbox:safe_primitive(actors:exit(_)).
sandbox:safe_primitive(actors:exit(_, _)).
sandbox:safe_primitive(actors:send(_, _)).
sandbox:safe_primitive(actors:send(_, _, _)).
sandbox:safe_primitive(actors:!(_, _)).
sandbox:safe_primitive(actors:cancel(_)).
sandbox:safe_primitive(actors:output(_)).
sandbox:safe_primitive(actors:output(_, _)).
sandbox:safe_primitive(actors:terminal_output(_)).
sandbox:safe_primitive(actors:terminal_output(_, _)).
sandbox:safe_primitive(actors:input(_, _)).
...
sandbox:safe_meta(actors:receive(Clauses), Calls) :-
    receive_meta_calls(Clauses, [], Calls).
sandbox:safe_meta(actors:receive(Clauses, Options), Calls) :-
    receive_meta_calls(Clauses, Options, Calls).
sandbox:safe_meta(actors:spawn(_Goal), []).
sandbox:safe_meta(actors:spawn(_Goal, _Pid), []).
sandbox:safe_meta(actors:spawn(_Goal, _Pid, _Options), []).
sandbox:safe_meta(actors:with_io_target(_Target, Goal), [Goal]).
