:- module(movie_db, [movie/2, director/2, actor/3, actress/3]).

% The movie database extracted from shared_db_n1.pl so that n1 imports it
% rather than carrying it inline — which makes n1 a *dependent* shared DB
% (see node_info_self_contained/1 and the discovery hub badge).
